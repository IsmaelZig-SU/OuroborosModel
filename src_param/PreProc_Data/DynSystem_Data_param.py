...
""""
Warning data divided by 4 here instead of two !!!!!!!!!!!!
...
class DynSystem_Data:
    ...
    def create_dataset(self, mode = "Both"):
        ...
        if mode == "Both" or mode == "Train":
            ...
            # for batch_index, (train_features, train_labels) in enumerate(self.train_dataloader):
            #     if batch_index % 4 == 0:  # Take only every fourth batch
